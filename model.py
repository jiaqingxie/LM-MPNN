...
class FusionModel(nn.Module):
    def __init__(self, chemberta_model, num_features, dim, graph_embedding_dim, out_dim, task):
        super().__init__()
        self.bert_model = ChemBERTaForPropertyPrediction(chemberta_model)
        self.gnn_model = NNConvModel(num_features, dim, graph_embedding_dim, out_dim, task)
