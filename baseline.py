...
if __name__ == "__main__":
    ...
    # model
    property_model = ChemBERTaForPropertyPrediction(chemberta_model=pretrain_chemberta,
    ...
    for epoch in range(args.epochs):
        ...
        valid_metric = test(valid_loader, property_model, target_std, args)
    ...
    print("########################################")
    print("Method: Language Model Baseline")
